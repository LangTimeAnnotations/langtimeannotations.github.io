...
var episode235 = [
    { time: "00:00", category: "Chat", text: "Chat" },
    { time: "00:58", category: "", text: "David shows Matthijs the classifiers from Sheli, David's contratone language" },
    { time: "03:12", category: "Chat", text: "Sheli's writing system (\"That writing system looks badass!\" - Miles)" },
    { time: "03:22", category: "", text: "Chair problems" },
    ...
    { time: "12:45", category: "", text: "David realizes notifications aren't disabled" },
    ...
    { time: "15:30", category: "", text: "David starts entering reciprocal pronoun \"zyizyis\" (\"each other\") from poll into dictionary" },
    { time: "15:55", category: "", text: "Jessie explains dictionary being updated with all backentries" },
    ...
    { time: "25:35", category: "", text: "Asking if Jessie's sync issues are bad enough to need fixing" },
    ...
    { time: "28:23", category: "", text: "Fixing Jessie's sync issues" },
    { time: "29:22", category: "Chat", text: "\"Ηαρργ βιρτδαγ\" - Noel Strüning" },
    { time: "29:37", category: "", text: "Ready to enter Jessie and David's names into dictionary" },
    { time: "29:53", category: "", text: "Jessie shows off work of listing dictionary order of inflected forms for nouns and verbs on page 38. David suggests moving it to page 36." },
    { time: "30:42", category: "Chat", text: "Jessie is \"shooting daggers\" at David" },
    { time: "33:00", category: "", text: "Dictionary entries for Jessie and David's names in Tpaalha, \"dabyid\" and \"dyisi\", respectively. David misspells \"summit\" as \"sumit\"." },
    { time: "34:30", category: "", text: "David switches to Lexurgy to determine how the dual suffix attaches to words that end with a shwa." },
    { time: "37:28", category: "", text: "Next steps - David will do font stuff, and Jessie will do more vocab creation. Jessie checks Patreon name entry submissions." },
    ...
    { time: "40:29", category: "", text: "Left side of document, or whole thing? Mostly left." },
    ...
    { time: "42:45", category: "", text: "David starts modern font work for Tpaalha" },
    ...
    { time: "43:15", category: "", text: "Discussion on modern spelling for Tpaalha" },
    { time: "44:10", category: "Chat", text: "\"*teleports some vegan pizza and pasta to Jessie*\" - Rag Doll" },
    { time: "44:42", category: "", text: "David discusses flip form diacritics in Tpaalha's modern font" },
    ...
    { time: "47:10", category: "", text: "David questions previous math work for placement of diacritic" },
    ...
    { time: "53:20", category: "", text: "David's perfectly centered diacritic" },
    { time: "54:00", category: "Chat", text: "Mice Summits (\"​the mice would hold summits\" - Jake Penny)" },
    { time: "54:10", category: "", text: "Jessie chooses meaning \"to burrow, to hide\" for new root \"tibosh\" and enters it into the dictionary" },
    { time: "56:35", category: "", text: "David tries to position the diacritic to his liking" },
    ...
    { time: "58:48", category: "", text: "Jessie asks about spelling of proto-form retroflex s" },
    ...
    { time: "01:02:57", category: "", text: "David recognizes incorrect positioning of some of the diacritics" },
    ...
    { time: "01:05:03", category: "", text: "David realizes the problem with the font - his IPA keyboard was on" },
    ...
    { time: "01:11:45", category: "", text: "Jessie selects final form for \"fox\" as \"khoi\" and enters it into the dictionary" },
    ...
    { time: "01:26:16", category: "", text: "Jessie mentions 2 things: There's 30 minutes left and need to think about a Poll. July 1st will be a new podcast release. David mentions thing 3: This episode will end slightly (5 minutes) early for a chat for a new movie they are working on." },
    { time: "01:28:58", category: "", text: "David is on last two glyphs with diacritics, and asks Jessie how the diacritics should be centered on them." },
    ...
    { time: "01:31:48", category: "", text: "Jessie suspects diminutives for nouns and verbal derivatioons haven't been done yet. The only nominal derivation is an augmentative." },
    { time: "01:32:58", category: "", text: "David having font problems" },
    ...
    { time: "01:38:23", category: "", text: "David creates new glyphs for poll: diacritic, dash near top, top bar, or top bar with serifs" },
    { time: "01:40:18", category: "Chat", text: "David: \"Plop on down like a pumpkin\"" },
    { time: "01:41:37", category: "", text: "David is disgusted at incorrect angle of glyph" },
    ...
    { time: "01:47:38", category: "", text: "David asks how to center the top bar of the glyph" },
    { time: "01:49:42", category: "Chat", text: "The Boondocks" },
    { time: "01:51:30", category: "", text: "David tries one more glyph for the poll, making 5 options in total" },
    { time: "01:54:39", category: "", text: "End" },
]
